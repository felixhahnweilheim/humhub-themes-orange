...
// changed: text-color in footer: text-color-soft instead of text-color-soft2
// changed: background-color of body and table: @default instead of @background-color-page
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="font-size:12px; font-family: <?= Yii::$app->view->theme->variable('mail-font-family', DefaultMailStyle::DEFAULT_FONT_FAMILY) ?>; background-color: <?= Yii::$app->view->theme->variable('default', '#fafafa') ?>;">
        <?php $this->beginBody() ?>

        <!--start 100% wrapper (white background) -->
        <table width="100%" id="mainStructure" border="0" cellspacing="0" cellpadding="0" style="background-color: <?= Yii::$app->view->theme->variable('default', '#fafafa') ?>;">
                                    ...
                                    <tr>
                                        <td valign="top">
                                            ...
                                            <table width="560" align="center" border="0" cellspacing="0" cellpadding="0" class="full-width">
                                                ...
                                                <tr>
                                                    <td valign="middle">
                                                        <?php $softColor = Yii::$app->view->theme->variable('text-color-soft', '#222121')?>
                                                            ...
                                                            <tr>
                                                                <td align="center" valign="top" style="font-size: 11px; line-height: 18px; font-weight:300; text-align: center; font-family: <?= Yii::$app->view->theme->variable('mail-font-family', DefaultMailStyle::DEFAULT_FONT_FAMILY) ?>;">
                                                                    ...
                                                                    <?php if (isset(Yii::$app->view->params['showUnsubscribe']) && Yii::$app->view->params['showUnsubscribe'] === true) : ?>
                                                                        ...
                                                                        <span style="text-decoration: none; color: <?= $softColor ?>;">
                                                                            <a href="<?= $url ?>" style="text-decoration: none; color: <?= $softColor ?>;"><?= Yii::t('base', 'Unsubscribe') ?></a>
                                                                            •
                                                                        </span>
                                                                    <?php endif; ?>
                                                                    ...
                                                                    <span style="text-decoration: none; color:<?= $softColor ?>;">
                                                                        ...
                                                                        <?= PoweredBy::widget(['linkOptions' => ['style' => 'text-decoration:none;color:'.$softColor]]); ?>
                                                                    </span>
