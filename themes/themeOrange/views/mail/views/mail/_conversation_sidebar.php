...
/*Changed: background-color-main instead of background-color-secondary*/
...
<div id="mail-conversation-overview" class="panel panel-default">
    <div class="panel-heading"  style="background-color:<?= $this->theme->variable('background-color-main')?>">
