...
/*changed: background-color of conversation header form background-color-secondary to default*/
...
<div class="panel panel-default">
    ...
    <?php  else :?>
        ...
        <div id="mail-conversation-header" class="panel-heading" style="background-color:<?= $this->theme->variable('default')?>">
